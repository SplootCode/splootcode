...
class DocumentNodeComponent extends Component<DocumentNodeProps> {
  ...
  sendNodeTreeToFrame() {
    ...
    if (millis > 1000) {
      let jsAst = this.props.rootNode.generateJsAst();
      let src = recast.print(jsAst).code;
      let payload = {type: 'commandlineapp', data:src};
...
export class CommandlinePage extends Component<ViewPageProps, ViewPageState> {
