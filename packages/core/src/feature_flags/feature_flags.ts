...
/*
To enable:
localStorage.setItem('SPLOOT_FEATURE_FLAGS', JSON.stringify({'ENABLE_HTTP_APPS_FLAG': true, 'ENABLE_STREAMLIT_APPS_FLAG': true, 'ENABLE_INSTALLABLE_PACKAGES_FLAG': true, 'ENABLE_TUTORIALS_FLAG': true}))
*/
