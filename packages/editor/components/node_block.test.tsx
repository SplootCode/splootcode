...
it('renders a single string literal node', () => {
  ...
  expect(pretty(container.innerHTML)).toMatchInlineSnapshot(`
    "<svg height=\\"20\\" width=\\"52\\">
      ...
      </g><text class=\\"string-node\\" x=\\"18\\" y=\\"15\\" style=\\"fill: var(--code-neutral-200);\\" xml:space=\\"preserve\\">hello this is string</text>
      <path class=\\"svgsplootnode\\" d=\\"M 40 0 v 20 h 10 q 4,0 4,-4 v -12 q 0,-4 -4,-4 z\\"></path>
